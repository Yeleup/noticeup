...
class ControllerInstallStep4 extends Controller {
	public function index() {
		...
		$data['text_amazon_pay'] = $this->language->get('text_amazon_pay');
        ...
        $data['catalog'] = $this->session->data['catalog'];
    ...
    private function sendMail($email) {
        ...
        $data['store'] = html_entity_decode('Noticeup.kz', ENT_QUOTES, 'UTF-8');
