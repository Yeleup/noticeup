<?php
class ModelStoreInformation extends Model {
    private $store_id = 0;
    ...
    public function addInformation($data) {
        ...
        $this->db->query("INSERT INTO " . DB_PREFIX . "information_to_store SET information_id = '" . (int)$information_id . "', store_id = '" . (int)$this->store_id . "'");
    ...
    public function editInformation($information_id, $data) {
        ...
        $this->db->query("INSERT IGNORE INTO " . DB_PREFIX . "information_to_store SET information_id = '" . (int)$information_id . "', store_id = '" . (int)$this->store_id . "'");
    ...
    public function getInformations($data = array()) {
        if ($data) {
            $sql = "SELECT * FROM " . DB_PREFIX . "information i LEFT JOIN " . DB_PREFIX . "information_description id ON (i.information_id = id.information_id) LEFT JOIN " . DB_PREFIX . "information_to_store i2s ON (i2s.information_id = i.information_id) WHERE i2s.store_id = '" . (int)$this->store_id . "' AND id.language_id = '" . (int)$this->config->get('config_language_id') . "'";
            ...
            $information_data = $this->cache->get('information.' . (int)$this->store_id . '.' . (int)$this->config->get('config_language_id'));
            ...
            if (!$information_data) {
                ...
                $this->cache->set('information.' . (int)$this->store_id . '.' . (int)$this->config->get('config_language_id'), $information_data);
            }
    ...
    public function getTotalInformations() {
        $query = $this->db->query("SELECT COUNT(*) AS total FROM " . DB_PREFIX . "information i LEFT JOIN " . DB_PREFIX . "information_to_store i2s ON (i2s.information_id = i.information_id) WHERE i2s.store_id = '" . (int)$this->store_id . "'");
    ...
    public function checkInformationForStore($information_id){
        $sql = "SELECT count(information_id) as total FROM " . DB_PREFIX . "information_to_store i2s WHERE i2s.information_id = '" . (int)$information_id . "' AND i2s.store_id=" . (int)$this->store_id;
