...
class ModelStoreManufacturer extends Model {
	...
	public function addManufacturer($data) {
        ...
        $this->db->query("INSERT INTO " . DB_PREFIX . "manufacturer_to_store SET manufacturer_id = '" . (int)$manufacturer_id . "', store_id = '" . (int)$this->store_id . "'");
	...
	public function editManufacturer($manufacturer_id, $data) {
        ...
        $this->db->query("INSERT IGNORE INTO " . DB_PREFIX . "manufacturer_to_store SET manufacturer_id = '" . (int)$manufacturer_id . "', store_id = '" . (int)$this->store_id . "'");
	...
	public function getManufacturers($data = array()) {
		$sql = "SELECT * FROM " . DB_PREFIX . "manufacturer m INNER JOIN " . DB_PREFIX . "manufacturer_to_store m2s ON m2s.manufacturer_id = m.manufacturer_id WHERE m2s.store_id = '" . (int)$this->store_id . "'";
    ...
    public function checkManufacturerForStore($manufacturer_id){
        $sql = "SELECT count(manufacturer_id) as total FROM " . DB_PREFIX . "manufacturer_to_store m2s WHERE m2s.manufacturer_id='" . (int)$manufacturer_id . "' AND m2s.store_id=" . (int)$this->store_id;
