<?php
class ModelStoreSaleOrder extends Model {
    private $store_id = 0;
	...
	public function getOrder($order_id) {
        if (!$this->checkOrderForStore($order_id)) {
            $this->session->data['error'] = $this->language->get('error_not_found');
            $this->response->redirect($this->url->link('store_sale/order', 'user_token=' . $this->session->data['user_token'], true));
        }
	...
	public function getOrders($data = array()) {
        ...
        $sql .= " AND o.store_id = '" . (int)$this->store_id . "'";
	...
	public function getTotalOrders($data = array()) {
        ...
        $sql .= " AND store_id = '" . (int)$this->store_id . "'";
    ...
    public function checkOrderForStore($order_id){
       $sql = "SELECT count(order_id) as total FROM " . DB_PREFIX . "order o WHERE o.order_id='" . (int)$order_id . "' AND o.store_id=" . (int)$this->store_id;
