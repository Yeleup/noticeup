<?php
class ModelStoreCustomerCustomer extends Model {
    private $store_id = 0;
	...
	public function getCustomer($customer_id) {
        if (!$this->checkCustomerForStore($customer_id)) {
            $this->session->data['error'] = $this->language->get('error_not_found');
            $this->response->redirect($this->url->link('store_customer/customer', 'user_token=' . $this->session->data['user_token'], true));
        }
	...
	public function getCustomers($data = array()) {
        ...
        $implode[] = "c.store_id = ".(int)$this->store_id;
	...
	public function getTotalCustomers($data = array()) {
        ...
        $implode[] = "store_id = ".(int)$this->store_id;
    ...
    public function checkCustomerForStore($customer_id){
        $sql = "SELECT count(customer_id) as total FROM " . DB_PREFIX . "customer c WHERE c.customer_id='".(int)$customer_id."' AND c.store_id=".(int)$this->store_id;
