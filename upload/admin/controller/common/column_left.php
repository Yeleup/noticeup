...
class ControllerCommonColumnLeft extends Controller {
	public function index() {
		if (isset($this->request->get['user_token']) && isset($this->session->data['user_token']) && ($this->request->get['user_token'] == $this->session->data['user_token'])) {
            ...
            if ($this->user->hasPermission('access', 'store/category')) {
                $catalog[] = array(
                    'name'	   => $this->language->get('text_category'),
                    'href'     => $this->url->link('store/category', 'user_token=' . $this->session->data['user_token'], true),
                    'children' => array()
                );
            }
            ...
            if ($this->user->hasPermission('access', 'store/product')) {
                $catalog[] = array(
                    'name'	   => $this->language->get('text_product'),
                    'href'     => $this->url->link('store/product', 'user_token=' . $this->session->data['user_token'], true),
                    'children' => array()
                );
            }
            ...
            if ($this->user->hasPermission('access', 'store/manufacturer')) {
                $catalog[] = array(
                    'name'	   => $this->language->get('text_manufacturer'),
                    'href'     => $this->url->link('store/manufacturer', 'user_token=' . $this->session->data['user_token'], true),
                    'children' => array()
                );
            }
            ...
            if ($this->user->hasPermission('access', 'store/information')) {
                $catalog[] = array(
                    'name'	   => $this->language->get('text_information'),
                    'href'     => $this->url->link('store/information', 'user_token=' . $this->session->data['user_token'], true),
                    'children' => array()
                );
            }
            ...
            if ($this->user->hasPermission('access', 'design/store_banner')) {
                $design[] = array(
                    'name'	   => $this->language->get('text_banner'),
                    'href'     => $this->url->link('design/store_banner', 'user_token=' . $this->session->data['user_token'], true),
                    'children' => array()
                );
            }
            ...
            if ($this->user->hasPermission('access', 'store_sale/order')) {
                $sale[] = array(
                    'name'	   => $this->language->get('text_order'),
                    'href'     => $this->url->link('store_sale/order', 'user_token=' . $this->session->data['user_token'], true),
                    'children' => array()
                );
            }
            ...
            if ($this->user->hasPermission('access', 'store_customer/customer')) {
                $customer[] = array(
                    'name'	   => $this->language->get('text_customer'),
                    'href'     => $this->url->link('store_customer/customer', 'user_token=' . $this->session->data['user_token'], true),
                    'children' => array()
                );
            }
            ...
            if ($this->user->hasPermission('access', 'setting/multistore')) {
                $system[] = array(
                    'name'	   => $this->language->get('text_setting'),
                    'href'     => $this->url->link('setting/multistore', 'user_token=' . $this->session->data['user_token'], true),
                    'children' => array()
                );
            }

            if ($this->user->hasPermission('access', 'store_setting/store')) {
                $system[] = array(
                    'name'	   => $this->language->get('text_setting'),
            ...
            if ($this->user->hasPermission('access', 'store_user/user')) {
                $user[] = array(
                    'name'	   => $this->language->get('text_users'),
                    'href'     => $this->url->link('store_user/user', 'user_token=' . $this->session->data['user_token'], true),
                    'children' => array()
                );
            }
            ...
            if ($this->registry->get('user')->store_id == 0) {
                if ($user) {
                    $system[] = array(
                        'name' => $this->language->get('text_users'),
                        'href' => '',
