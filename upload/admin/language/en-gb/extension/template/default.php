<?php
// Heading
$_['heading_title']                    = 'Default Store template';

// Text
$_['text_extension']                   = 'Extensions';
$_['text_success']                     = 'Success: You have modified the default store template!';
$_['text_edit']                        = 'Edit Default Store template';
$_['text_general']                     = 'General';
$_['text_product']                     = 'Products';
$_['text_image']                       = 'Images';

// Entry
$_['entry_directory']                  = 'template Directory';
...
// Help
$_['help_directory']                   = 'This field is only to enable older templates to be compatible with the new template system. You can set the template directory to use on the image size settings defined here.';
...
// Error
$_['error_permission']                 = 'Warning: You do not have permission to modify the default store template!';
